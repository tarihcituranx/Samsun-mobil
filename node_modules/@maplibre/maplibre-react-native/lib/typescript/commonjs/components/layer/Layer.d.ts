...
import { type BackgroundLayerStyle, type CircleLayerStyle, type FillExtrusionLayerStyle, type FillLayerStyle, type HeatmapLayerStyle, type LineLayerStyle, type RasterLayerStyle, type SymbolLayerStyle } from "../../types/MapLibreRNStyles";
/**
 ...
 */
type StyleSpecLayerProps = OptionalSource<OptionalId<LayerSpecification>> & BaseLayerProps & {
...
export type LayerProps = StyleSpecLayerProps | FillLayerProps | LineLayerProps | SymbolLayerProps | CircleLayerProps | HeatmapLayerProps | FillExtrusionLayerProps | RasterLayerProps | BackgroundLayerProps;
/**
 ...
 * ```
 */
export declare const Layer: ({ id, ...props }: LayerProps) => import("react/jsx-runtime").JSX.Element;
export {};
