...
export interface Spec extends TurboModule {
    ...
    setSourceVisibility: (reactTag: CodegenTypes.Int32, visible: boolean, source: string, sourceLayer: string | null) => Promise<void>;
    createStaticMapImage: (reactTag: CodegenTypes.Int32, output: "base64" | "file") => Promise<string>;
