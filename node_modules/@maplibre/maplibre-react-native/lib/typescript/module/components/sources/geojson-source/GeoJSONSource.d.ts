...
import { Component, type ComponentProps, type ReactNode, type Ref } from "react";
...
export type NativeGeoJSONSourceRef = Component<ComponentProps<typeof GeoJSONSourceNativeComponent>> & ReactNativeElement;
